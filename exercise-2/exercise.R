...
old.salaries <- runif(100, min = 40000, max = 50000)
...
new.salaries <- old.salaries + runif(100, min = -1000, max = 1000)

# Create a data.frame 'salaries' by combining the 3 vectors you just made
# Remember to set `stringsAsFactors=FALSE`!
salaries <- data.frame(employees, old.salaries, new.salaries)
...
employee.57 <- salaries[salaries$employees == "Employee 57", "new.salaries"]
